<template>
  ...
  <h2 v-if="this.name !== null">Welcome back, {{ this.name }}</h2>
  <span class="fa-stack fa-lg" style="color: green">
  <i class="fa fa-circle fa-stack-2x"></i>
  <i class="fa fa-flag fa-stack-1x fa-inverse" style="color: white"></i>
</span>
<p style="color: gray">
To get insured, one has to add essential information about them, <br> and then calculate their plan cover from then on. <br>
You'll find these links on the navigation bar.</p>
  <br>
  <div class="white-text-container background-image-container" :style="bgImg">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <h1>About Us</h1>
                <p>The main goal for this system is to make Life Insurance much simpler for everyone. On this site, you can calculate how much money you're going to need to get covered.</p>
                <a href='/calculator' title="" class="btn btn-lg btn-primary">Calculate Plan Cover</a>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="row">
                <div class="col-md-12 section-container-spacer">
                    <div class="text-center">
                        ...
                        <p> I decided to delve deep into this project because looking after one’s family in case the worse happens is of paramount importance to me. <br> </p>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <div>
                        <p>I want to come up with something that simplifies the insurance business to the core, with zero hassles, is easy to understand, and navigate for clients on their own without hiring too many people that’ll have to explain and print out too much paperwork that has to be decoded by lawyers, which, on its own, is expensive and tiresome.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="fa-container">
                    ...
                    <div>
                        <p>
                          I want to have a minimalist UI whereby the first page that pops up when you type in the URL is where the client will either sign up or log in. Authentication is going to use JS form validation and then check if the mentioned customer is included in the database. When one logs in, they get to update their profile, add, delete, update and even delete their dependencies.
                        </p>
                    </div>
                </div>
                <div class="col-md-4">
                    ...
                    <div>
                        <p>
                          When all of this has been done, they should click a button that has the whole algorithm that’ll calculate what their new monthly premium will be, depending on all the new updates that have been made, including the most basic factors like BMI, age, gender, number of dependencies mentioned, family medical history, and financial wellbeing.
                        </p>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
              <div class="col-md-25">
                    ...
                    <p style="font-size: large;">&copy; Made with <span style="color: tomato">love</span> by Brian Mthembu &trade;</p>
                  </div>
            </div>
        </div>
    </div>
...
export default{
    ...
    beforeMount(){
      ...
      if(localStorage.getItem('user') !== 'null')
        localStorage.setItem('surname', localStorage.getItem('userlast'))
      }
}
