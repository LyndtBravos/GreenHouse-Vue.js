...
<div id="app">
    ...
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href='/' title="" style="display: flex; align-items: center; justify-content: center;">
            <img src="@/assets/9.png" style="width: 75px; height: 75px;" class="navbar-logo-img" alt="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;GreenHouse Life Insurance 
        </a>
      </div>

      <div class="collapse navbar-collapse" id="navbar-collapse-uarr">
        <ul class="nav navbar-nav navbar-right">
          <li><a href='/view' v-if="this.user == '[object Object]'" title="">View Information</a></li>
          <li><a href='/calculator' title="">Calculator</a></li>
          <li><a href='/user' v-if="this.user == '[object Object]'" title="">Update User</a></li>
          <li><a href='/info' v-if="this.user == '[object Object]'" title="">Info Page</a></li>
          <li><a href='/plan' v-if="this.user == '[object Object]' && (this.bought !== null && this.bought !== 'undefined')" title="">Plan Page</a></li>
          
          
          <li><a @click="logout()" style="color: tomato; cursor: pointer;" v-if="this.user == '[object Object]'" title="" class="active">Logout</a></li>
          <li>
            <p>
              <a href='/authentication' v-if="this.user !== '[object Object]'" class="btn btn-primary navbar-btn" title="">Register/Log-in</a>
            </p>
          </li>
...
export default{
    ...
    methods: {
        ...
        aboutUs(){
            window.open('http://localhost:8080/about#loaded', '_self')
        }
        },
    beforeMount(){
        // this.function();
